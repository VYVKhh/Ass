...
def start(message):
    ...
    if not check_subscription(message.from_user.id):
        ...
        subscribe_button = types.InlineKeyboardButton("اشترك في القناة", url='https://t.me/DAM_FAR')
    ...
    developer_button = types.InlineKeyboardButton("قناة مطور البوت", url='https://t.me/DAM_FAR')
...
def handle_file(message):
    try:
        ...
        if not scan_file_for_viruses(file_content, bot_script_name):
            ...
            bot.reply_to(message, "تم حظرك من البوت تواصل مع المطور @M3_mo2")
            return
